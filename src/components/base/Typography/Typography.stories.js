...
import Title, { Headliine, SubTitle, Description, Link, Number } from "base/Typography";
...
storiesOf("Application|Style Guides/", module)
  ...
  .add("Typography", () => {
    return (
      <Panel>
        <Grid columns="1">
          <Headliine text="Numbers" />
          <Number text="1234567890" />
          <Number text="3.14" />
          <Number text="1/2" />
          <Headliine text="Components" />
