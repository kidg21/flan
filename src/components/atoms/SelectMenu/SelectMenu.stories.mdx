...
<Meta title="Data Entry|Dropdown Menu" component={SelectMenu} />

# Dropdown Menu

#### Dropdown Menu is a type of input that is used in forms, where a user is submitting data and chooses one option from a list.
