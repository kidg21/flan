...
<Meta title="Data Entry|Range Inputs/Slider" component={Slider} />
...
<Preview withToolbar>
  <Story name="Standard">
    <Slider id="default" label="Slider" min={1} max={20} value={8} />
  </Story>
</Preview>
...
<Preview>
  <Story name="Types">
    <Form columns="1">
      ...
      <FormSection title="With Label">
        <Slider min={1} max={20} value={1} withLabel />
      </FormSection>
      <FormSection title="With Range">
        <Slider  min={1} max={20} value={15} withRange />
      </FormSection>
    </Form>
  </Story>
</Preview>
