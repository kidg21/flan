...
<Preview withToolbar>
  <Story name="Standard">
    <Slider id="default" label="Slider" min="1" max="20" defaultValue="8"/>
  </Story>
</Preview>
...
<Preview>
  <Story name="States">
    <Form columns="1">
      ...
      <Section title="Error">
        <Slider error min="1" max="20" />
      </Section>
      <Section title="Disabled">
        <Slider disabled min="1" max="20" />
      </Section>
    </Form>
  </Story>
</Preview>
...
<Preview>
  <Story name="Types">
    <Form columns="1">
      <Section title="Standard">
        <Slider min="1" max="20" defaultValue="4" />
      </Section>
      <Section title="With Label">
        <Slider min="1" max="20" defaultValue="4" withLabel />
      </Section>
      <Section title="With Range">
        <Slider  min="1" max="20" defaultValue="4" withRange />
      </Section>
    </Form>
  </Story>
</Preview>
