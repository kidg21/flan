    ...
    <PanelBody>
      <Form>
        <InputBlock>
          ...
          <Input label="Input ( 2 Column Input )" two={true} />
          <Input
            label="Input ( 3 Column Input )"
            three={true}
            placeholder_2="Two!!"
            placeholder_3="Three!!!"
          />
          ...
          />
          {/* <Input_2_Column label="2 Column Input" /> */}
          {/* <Input_3_Column label="3 Column Input" /> */}
        </InputBlock>
      </Form>
    </PanelBody>
  </Panel>
));
>>>>>>> 122823beeb0120d26ab1cc15aa67977865204d59
